...
# Form implementation generated from reading ui file 'forms\liderWcFormDodaj.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.combo_lider = QtWidgets.QComboBox(self.widget_4)
        self.combo_lider.setMinimumSize(QtCore.QSize(150, 0))
        self.combo_lider.setObjectName("combo_lider")
        self.horizontalLayout_2.addWidget(self.combo_lider)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Lider <--> Grupa robocza - nowy"))
