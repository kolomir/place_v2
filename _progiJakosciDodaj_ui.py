...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.combo_ranga = QtWidgets.QComboBox(self.widget_4)
        ...
        self.combo_lokalizacja.setMinimumSize(QtCore.QSize(150, 0))
        self.combo_lokalizacja.setObjectName("combo_lokalizacja")
        self.horizontalLayout.addWidget(self.combo_lokalizacja)
        spacerItem1 = QtWidgets.QSpacerItem(29, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.combo_wc = QtWidgets.QComboBox(self.widget_3)
        self.combo_wc.setMinimumSize(QtCore.QSize(150, 0))
        self.combo_wc.setObjectName("combo_wc")
        self.horizontalLayout.addWidget(self.combo_wc)
        ...
        self.text_prog1 = QtWidgets.QLineEdit(self.widget_5)
        self.text_prog1.setMinimumSize(QtCore.QSize(60, 0))
        self.text_prog1.setAlignment(QtCore.Qt.AlignCenter)
        self.text_prog1.setObjectName("text_prog1")
        self.horizontalLayout_3.addWidget(self.text_prog1)
        spacerItem2 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem2)
        self.text_prog2 = QtWidgets.QLineEdit(self.widget_5)
        self.text_prog2.setMinimumSize(QtCore.QSize(60, 0))
        ...
        self.text_prog3 = QtWidgets.QLineEdit(self.widget_5)
        self.text_prog3.setMinimumSize(QtCore.QSize(60, 0))
        self.text_prog3.setAlignment(QtCore.Qt.AlignCenter)
        self.text_prog3.setObjectName("text_prog3")
        self.horizontalLayout_3.addWidget(self.text_prog3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Progi jakości - nowy"))
