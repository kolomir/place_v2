...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lab_lokalizacja.setMinimumSize(QtCore.QSize(150, 0))
        self.lab_lokalizacja.setObjectName("lab_lokalizacja")
        self.horizontalLayout.addWidget(self.lab_lokalizacja)
        spacerItem1 = QtWidgets.QSpacerItem(29, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.lab_wc = QtWidgets.QLabel(self.widget_3)
        self.lab_wc.setMinimumSize(QtCore.QSize(150, 0))
        self.lab_wc.setObjectName("lab_wc")
        self.horizontalLayout.addWidget(self.lab_wc)
        ...
        self.lab_prog1 = QtWidgets.QLabel(self.widget_5)
        self.lab_prog1.setMinimumSize(QtCore.QSize(60, 0))
        self.lab_prog1.setObjectName("lab_prog1")
        self.horizontalLayout_3.addWidget(self.lab_prog1)
        ...
        self.lab_prog2.setMinimumSize(QtCore.QSize(60, 0))
        ...
        self.lab_prog3 = QtWidgets.QLabel(self.widget_5)
        self.lab_prog3.setMinimumSize(QtCore.QSize(60, 0))
        self.lab_prog3.setObjectName("lab_prog3")
        self.horizontalLayout_3.addWidget(self.lab_prog3)
    ...
    def retranslateUi(self, Form):
        ...
        self.lab_ranga.setText(_translate("Form", "TextLabel"))
        self.check_aktywny.setText(_translate("Form", "Aktywny"))
        self.lab_lokalizacja.setText(_translate("Form", "TextLabel"))
        self.lab_wc.setText(_translate("Form", "TextLabel"))
        self.lab_prog1.setText(_translate("Form", "TextLabel"))
        self.lab_prog2.setText(_translate("Form", "TextLabel"))
        self.lab_prog3.setText(_translate("Form", "TextLabel"))
        self.lab_kwota.setText(_translate("Form", "TextLabel"))
