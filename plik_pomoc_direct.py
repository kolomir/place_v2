...
from _plik_pomoc_direct_ui import Ui_Form
import db, dodatki


class MainWindow_pomoc_direct(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_Form()
        ...
        self.image_paths = ["img/pomoc/recording statistic 1.png", "img/pomoc/recording statistic 2.png"]
