...
# Form implementation generated from reading ui file 'forms\korekta_indirect_prod.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_zapisz = QtWidgets.QPushButton(self.widget_5)
        self.btn_zapisz.setMaximumSize(QtCore.QSize(140, 16777215))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Korekta Indirect Work"))
        ...
        self.btn_importuj.setText(_translate("Form", "Importuj listę"))
        self.btn_zapisz.setText(_translate("Form", "dodaj korektę"))
import icon_rc
