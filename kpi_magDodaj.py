...
class MainWindow_kpi_magDodaj(QWidget):
    ...
    def zapisz(self):
        ...
        insert_data = "INSERT INTO kpi_mag VALUES (NULL, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');" % (str(pole_delivery), str(pole_reklamacje), str(pole_dp_init), str(pole_zgodnosc), '0', '0', miestac, teraz)
