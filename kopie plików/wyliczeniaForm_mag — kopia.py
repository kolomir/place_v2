...
# = WYSYŁKA ==============================================================================================================================================================
    ...
    def sprawdz_wpisy(self):
        ...
        select_data_eksport = "SELECT * FROM eksport_danych ed WHERE ed.miesiac = '{0}' and ed.dzial = 'mag'".format(miestac_roboczy)
        connection = db.create_db_connection(db.host_name, db.user_name, db.password, db.database_name)
        ...
        if result_eksport:
            ...
            for x in result_eksport:
                delete_data = "delete from eksport_danych where id = '%s' and miesiac = '%s' and dzial = 'mag';" % (x[0], miestac_roboczy)
