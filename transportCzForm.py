...
from _transportCzForm_ui import Ui_Form
import db

from transportCzFormDodaj import MainWindow_transportCzFormDodaj
...
class MainWindow_transportCzForm(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_Form()
        ...
        self.ui.btn_zapisz.clicked.connect(self.otworz_okno_transportCzFormDodaj)
    ...
    def load_data_from_database(self):
        ...
        try:
            select_data = '''select 
                                                ...
                                                ,tp.data_edycji 
                                            from 
                                                transport_produkcji tp 
                                                    left join instruktor i on i.id = tp.id_pracownik 
                                                    left join linie l on l.id = tp.id_linia;'''
    ...
    def otworz_okno_transportCzFormDodaj(self):
        self.okno_transportCzFormDodaj = MainWindow_transportCzFormDodaj()
        self.okno_transportCzFormDodaj.show()