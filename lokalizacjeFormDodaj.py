...
from _lokalizacjeFormDodaj_ui import Ui_Form
import db

class MainWindow_lokalizacjeDodaj(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_Form()
    ...
    def zapisz(self):
        ...
        insert_data = "INSERT INTO lokalizacja VALUES (NULL, '%s', '%s');" % (pole_linie, str(aktywny))
        print(insert_data)
