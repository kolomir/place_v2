...
from _plik_pomoc_nieobecnosci_ui import Ui_Form
import db, dodatki


class MainWindow_pomoc_nieobecnosci(QWidget):
    def __init__(self):
        super().__init__()
        self.ui = Ui_Form()
        ...
        self.image_paths = ["img/pomoc/01 nieobecnosci.png", "img/pomoc/02 nieobecnosci.png", "img/pomoc/03 nieobecnosci.png"]
