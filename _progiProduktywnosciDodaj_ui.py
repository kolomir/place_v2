...
# Form implementation generated from reading ui file 'forms\progiProduktywnosciDodaj.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.combo_ranga.setMinimumSize(QtCore.QSize(150, 0))
        self.combo_ranga.setObjectName("combo_ranga")
        self.horizontalLayout_5.addWidget(self.combo_ranga)
        ...
        self.text_prog1 = QtWidgets.QLineEdit(self.widget_12)
        self.text_prog1.setMinimumSize(QtCore.QSize(100, 0))
        self.text_prog1.setAlignment(QtCore.Qt.AlignCenter)
        self.text_prog1.setObjectName("text_prog1")
        self.horizontalLayout_6.addWidget(self.text_prog1)
        spacerItem1 = QtWidgets.QSpacerItem(47, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem1)
        self.text_kwota1 = QtWidgets.QLineEdit(self.widget_12)
        self.text_kwota1.setMinimumSize(QtCore.QSize(100, 0))
        self.text_kwota1.setText("")
        self.text_kwota1.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.text_kwota1.setObjectName("text_kwota1")
        self.horizontalLayout_6.addWidget(self.text_kwota1)
        ...
        self.text_prog2 = QtWidgets.QLineEdit(self.widget_10)
        self.text_prog2.setMinimumSize(QtCore.QSize(100, 0))
        self.text_prog2.setAlignment(QtCore.Qt.AlignCenter)
        self.text_prog2.setObjectName("text_prog2")
        self.horizontalLayout_3.addWidget(self.text_prog2)
        spacerItem2 = QtWidgets.QSpacerItem(47, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem2)
        self.text_kwota2 = QtWidgets.QLineEdit(self.widget_10)
        self.text_kwota2.setMinimumSize(QtCore.QSize(100, 0))
        self.text_kwota2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.text_kwota2.setObjectName("text_kwota2")
        self.horizontalLayout_3.addWidget(self.text_kwota2)
        ...
        self.text_prog3 = QtWidgets.QLineEdit(self.widget_8)
        self.text_prog3.setMinimumSize(QtCore.QSize(100, 0))
        self.text_prog3.setAlignment(QtCore.Qt.AlignCenter)
        self.text_prog3.setObjectName("text_prog3")
        self.horizontalLayout_2.addWidget(self.text_prog3)
        spacerItem3 = QtWidgets.QSpacerItem(47, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem3)
        self.text_kwota3 = QtWidgets.QLineEdit(self.widget_8)
        self.text_kwota3.setMinimumSize(QtCore.QSize(100, 0))
        self.text_kwota3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.text_kwota3.setObjectName("text_kwota3")
        self.horizontalLayout_2.addWidget(self.text_kwota3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Progi produktywności - nowy"))
        ...
        self.text_kwota1.setPlaceholderText(_translate("Form", "kwota 1"))
        ...
        self.text_kwota2.setPlaceholderText(_translate("Form", "kwota 2"))
        ...
        self.text_kwota3.setPlaceholderText(_translate("Form", "kwota 3"))
