...
# Form implementation generated from reading ui file 'Forms\grupy_magDodaj.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.text_grupa = QtWidgets.QLineEdit(self.widget_3)
        self.text_grupa.setObjectName("text_grupa")
        self.verticalLayout.addWidget(self.text_grupa)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Grupy magazynu - dodawanie"))
        self.label_2.setText(_translate("Form", "v1"))
        self.text_grupa.setPlaceholderText(_translate("Form", "Grupa"))
