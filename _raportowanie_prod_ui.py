...
# Form implementation generated from reading ui file 'forms\raportowanie_prod.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_foto = QtWidgets.QPushButton(self.widget_5)
        self.btn_foto.setMinimumSize(QtCore.QSize(25, 25))
        self.btn_foto.setMaximumSize(QtCore.QSize(25, 25))
        self.btn_foto.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/img/svg_icons/image.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_foto.setIcon(icon)
        self.btn_foto.setObjectName("btn_foto")
        self.horizontalLayout_2.addWidget(self.btn_foto)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Raportowanie produkcji"))
