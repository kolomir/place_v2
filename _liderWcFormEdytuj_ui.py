...
# Form implementation generated from reading ui file 'forms\liderWcFormEdytuj.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lab_lider = QtWidgets.QLabel(self.widget_4)
        self.lab_lider.setMinimumSize(QtCore.QSize(150, 0))
        self.lab_lider.setObjectName("lab_lider")
        self.horizontalLayout_2.addWidget(self.lab_lider)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Lider <--> Grupa robocza - edytuj"))
        self.label_2.setText(_translate("Form", "v1"))
        self.lab_lider.setText(_translate("Form", "TextLabel"))
